...
// extern "C" void _mlir_ciface_print_open_gagan(double flops){
//   int a=10;
// printf("%f Hello World Gagan \n",flops);
// }
extern "C" void _mlir_ciface_print_open_gagan(double flops);

extern "C" void _mlir_ciface_print_open_array(float arr[2048][2048]){
  int a=10;
printf("%d Hello World array\n",a);
...
// extern "C" void print_gagn() {
//   fprintf(stderr, " GFLOPS Is Gagan Janab\n");
// }
// extern "C" void print_open_gagan() { printf("Hello Gagan ji\n"); }
