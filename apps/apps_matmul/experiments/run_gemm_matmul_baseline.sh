...
rm gemm_matmul
LIBXSMM_LIB=../../libxsmm/
icc -O3 -I${LIBXSMM_LIB}/include -fopenmp -DM1=$M1 -DN1=$N1 -DK1=$K1 -DNUM_ITERS=$iters -L${LIBXSMM_LIB}/lib ../versions/gemm_matmul.c -o gemm_matmul -lxsmm -lxsmmext -ldl -lm
